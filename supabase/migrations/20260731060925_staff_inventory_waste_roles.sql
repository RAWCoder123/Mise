-- Allow active staff to record waste / spoilage.
-- Absolute count edits, par/reorder changes, and ordering remain manager+.
...
comment on function public.service_record_inventory_waste_and_signals(
  ...
  'Service-owned waste / spoilage write path for owner/admin/manager/staff. Authenticated clients must call through operational-workflows.';
