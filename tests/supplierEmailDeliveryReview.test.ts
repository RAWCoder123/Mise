...
const migration = readFileSync(
  "supabase/migrations/20260826150000_supplier_email_delivery_review_resolution.sql",
  "utf8"
);
...
test("delivery review migration installs authenticated manager resolution without service-role forgery", () => {
  ...
  assert.match(migration, /lock_supplier_authority/);
  assert.match(migration, /clear_supplier_email_delivery_resolution_on_reclaim/);
  assert.match(
    migration,
