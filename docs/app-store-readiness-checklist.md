...
| Recipe coverage / settings list | tested (code) | Coverage matches normalized POS menu keys; Settings → Recipes loads full mapped list (not top-6 only); count drafts parse locale decimals |
