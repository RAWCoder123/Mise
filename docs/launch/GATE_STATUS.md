...
| 2. Inventory truth | In progress | Effective-dated mapping schema/domain rules, canonical units, append-only event ledger, replay-safe manager RPC, serialized AsyncStorage outbox/worker, hosted/demo submission adapter, count reconciliation | Hosted-staging adapter proof, screen submission wiring, receiving UI integration |
