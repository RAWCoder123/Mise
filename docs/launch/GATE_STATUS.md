...
| 2. Inventory truth | In progress | Effective-dated mapping schema/domain rules, canonical units, append-only event ledger, replay-safe manager RPC, serialized AsyncStorage outbox/worker, count reconciliation | Hosted submission adapter and screen submission wiring, receiving UI integration |
