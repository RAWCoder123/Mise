...
export function restaurantIdentityOptions(restaurant: Restaurant | null | undefined) {
  ...
  const brandColors = uniquePreserveOrder([
    ...(restaurant?.brand_color ? [normalizeHexColorDraft(restaurant.brand_color, restaurant.brand_color)] : []),
    ...(restaurant?.accent_color ? [normalizeHexColorDraft(restaurant.accent_color, restaurant.accent_color)] : []),
