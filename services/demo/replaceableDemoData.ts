    ...
    recalculationRuns: [
      {
        ...
        durationMs: 121_000,
        timedOut: true,
        failureReason: "Opening recalculation timed out after inventory projection.",
        cycleKey: `recalculation:${today}:daily_open`,
        idempotencyKey: `recalculation:${today}:daily_open:attempt-4`,
        recordedBy: DEMO_USER_ID,
        recordedAt: now,
        correlationId: "00000000-0000-4000-8000-000000000c11"
      },
      {
        ...
        timedOut: false,
        failureReason: null,
        cycleKey: `recalculation:${today}:mid_shift`,
        idempotencyKey: `recalculation:${today}:mid_shift:attempt-1`,
        recordedBy: DEMO_USER_ID,
        recordedAt: now,
        correlationId: "00000000-0000-4000-8000-000000000c12"
      },
      {
        ...
        durationMs: 42_000,
        timedOut: false,
        failureReason: "Close recalculation could not read today's waste ledger.",
        cycleKey: `recalculation:${today}:close`,
        idempotencyKey: `recalculation:${today}:close:attempt-2`,
        recordedBy: DEMO_USER_ID,
        recordedAt: now,
        correlationId: "00000000-0000-4000-8000-000000000c13"
      }
    ],
    auditLogs: [
      {
